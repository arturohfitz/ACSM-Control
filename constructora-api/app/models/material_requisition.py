...
class MaterialRequisitionItem(Base):
    ...
    requested_base_quantity: Mapped[Decimal | None] = mapped_column(Numeric(14, 4))
    unit_conversion_factor: Mapped[Decimal | None] = mapped_column(Numeric(18, 8))
    coverage_houses: Mapped[Decimal | None] = mapped_column(Numeric(12, 2))
