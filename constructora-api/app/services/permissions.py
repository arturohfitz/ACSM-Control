...
DEFAULT_PERMISSIONS: list[tuple[str, str, str]] = [
    ...
    ("material_requisitions", "edit", "Editar requerimientos de material de obra"),
    ...
    ("material_requisitions", "cancel", "Cancelar requerimientos de material de obra"),
...
DEFAULT_TENANT_ROLE_TEMPLATES: list[tuple[str, str, set[str]]] = [
    ...
    (
        "Obra",
        "Captura de requerimientos de material desde obra hacia Compras",
        {
            "clients:view",
            "projects:view",
            "house_models:view",
    ...
    (
        "Inventario",
        "Recepcion de material, documentos, faltantes y existencias de bodega",
        {
            "clients:view",
            "projects:view",
            "house_models:view",
    ...
    (
        ...
        "Cotizaciones comerciales, costos, utilidad, materiales y mano de obra",
        {
            "clients:view",
            "projects:view",
            "house_models:view",
    ...
    (
        "Compras",
        "Solicitudes a proveedores, captura de cotizaciones y envio de OC aprobadas",
        {
            "clients:view",
            "projects:view",
            "materials:view",
    ...
    (
        "Gerencia de compras",
        "Revision de comparativos, excepciones y autorizacion para generar ordenes de compra",
        {
            "clients:view",
            "projects:view",
            "materials:view",
    ...
    (
        "Pagos a proveedores",
        "Facturas, validacion contra inventario, programacion y registro de pagos",
        {
            "clients:view",
            "projects:view",
            "suppliers:view",
    ...
    (
        "Auditoria",
        "Consulta de eventos, documentos, compras, inventario, facturas y pagos sin captura",
        {
            "companies:view",
            "settings:view",
            "events:view",
