...
class SecurityHelpersTest(unittest.TestCase):
    ...
    def test_tenant_role_templates_separate_operational_duties(self) -> None:
        ...
        cuentas_por_pagar = self._tenant_role_codes("Cuentas por pagar")
        ...
        self.assertIn("supplier_invoices:view", compras)
        self.assertIn("supplier_invoices:upload", compras)
        self.assertNotIn("supplier_quotes:approve", compras)
        self.assertNotIn("supplier_invoices:validate", compras)
        ...
        self.assertNotIn("supplier_invoices:view", inventarios)
        self.assertNotIn("supplier_invoices:upload", inventarios)
        self.assertNotIn("supplier_invoices:validate", inventarios)
        ...
        self.assertIn("supplier_invoices:view", cuentas_por_pagar)
        self.assertIn("supplier_invoices:upload", cuentas_por_pagar)
        self.assertIn("supplier_invoices:validate", cuentas_por_pagar)
